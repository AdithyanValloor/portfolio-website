...
export function Journey() {
  return (
    <Section
      id="journey"
      className="border-y border-zinc-800/50 bg-zinc-900/30"
    >
                ...
                <article className="group relative pl-10">
                  ...
                  <div
                    className={`
                      ...
                      ${
                        item.current
                          ? "border-accent/70 shadow-[0_0_16px_rgba(59,130,246,0.25)]"
                          : "border-zinc-700 group-hover:border-zinc-500"
                      }
                    `}
                  >
                    {item.current ? (
                      <span className="h-2 w-2 rounded-full bg-accent shadow-[0_0_8px_rgba(59,130,246,0.8)]" />
                    ) : (
